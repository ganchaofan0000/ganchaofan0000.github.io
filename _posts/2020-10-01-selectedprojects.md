...
<div style="margin-bottom: 20px;">
  ...
  <div style="display: flex; align-items: center; background-color: rgb(106, 120, 138); color: black; border-radius: 4px; overflow: hidden;">
    ...
    <div style="flex: 2; padding-left: 1px; padding-top: 12px; padding-bottom: 13px; margin-left: 30px;">
      ...
      <p style="margin: -1px 0;"><a href="https://arxiv.org/abs/xxxx.xxxxx" target="_blank">[Arxiv]</a>, <a href="https://yihangchen-ee.github.io/project_fcgs/" target="_blank">[Project Page]</a>, <a href="https://github.com/yihangchen-ee/fcgs/" target="_blank">[Code]</a></p>
    </div>
  </div>
...
<div style="margin-bottom: 20px;">
  ...
  <div style="display: flex; align-items: center; background-color: rgb(106, 120, 138); color: black; border-radius: 4px; overflow: hidden;">
    ...
    <div style="flex: 2; padding-left: 1px; padding-top: 12px; padding-bottom: 13px; margin-left: 30px;">
      ...
      <p style="margin: -1px 0;"><a href="https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/01178.pdf" target="_blank">[Paper]</a>, <a href="https://arxiv.org/abs/2403.14530" target="_blank">[Arxiv]</a>, <a href="https://yihangchen-ee.github.io/project_hac/" target="_blank">[Project Page]</a>, <a href="https://github.com/yihangchen-ee/hac/" target="_blank">[Code]</a></p>
    </div>
  </div>
