...
<div style="margin-bottom: 20px;">
  ...
  <div style="display: flex; align-items: center; background-color: rgb(106, 120, 138); color: black; border-radius: 4px; overflow: hidden;">
    ...
    <div style="flex: 2; padding-left: 1px; padding-top: 12px; padding-bottom: 13px; margin-left: 30px;">
      ...
      <p style="margin: -1px 0;"><a href="https://github.com/YihangChen-ee/FCGS/blob/main/Fast_Feedforward_3D_Gaussian_Splatting_Compression____ARXIV.pdf" target="_blank">[Arxiv]</a>, <a href="https://yihangchen-ee.github.io/project_fcgs/" target="_blank">[Project]</a>, <a href="https://github.com/yihangchen-ee/fcgs/" target="_blank">[Code]</a></p>
    </div>
  </div>
